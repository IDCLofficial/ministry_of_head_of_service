      ...
      <div className="flex flex-col gap-8 items-left w-full md:w-[90%] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row h-full justify-between w-full gap-6 lg:gap-4">
            ...
            <div className="w-full lg:w-auto flex flex-col gap-4">
              <PageTransition type="fadeUp">
                <p className="text-gray-200 text-[1rem] lg:max-w-lg text-justify texl-lg">
                    {subtitle}
                </p>
              </PageTransition>
              <AppLink href="/about-us" label="Learn More" variant="secondary" 
              className="border-1 border-primary-green text-[15px] px-[2rem] py-[12px] rounded-[3.4px] 
